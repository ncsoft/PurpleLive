...
#define ELPP_GBCT				1
#define ELPP_DEFAULT_LOG_FILE	"NCCaptureSDK"
#define ELPP_THREAD_SAFE
#define AUTO_INITIALIZE_EASYLOGGINGPP

#if ELPP_GBCT
	// log-enable : DEBUG, INFO, ERROR
	...
	#define ELOGI LOG(INFO)
	#define ELOGD LOG(DEBUG)
	#define ELOGW LOG(WARNING)
	#define ELOGE LOG(ERROR)
	#define ELOGF LOG(FATAL)
	#define ELOGV LOG(VERBOSE)
	#define ELOGT LOG(TRACE)
#endif

void elpp_set_configure(const char* config);
...
class Storage : base::NoCopy, public base::threading::ThreadSafe {
 public:
  ...
  explicit Storage();
  void initialize(const LogBuilderPtr& defaultLogBuilder);
#endif  // ELPP_ASYNC_LOGGING
...
#else
#  define INITIALIZE_EASYLOGGINGPP ELPP_INIT_EASYLOGGINGPP(new el::base::Storage())
#endif  // ELPP_ASYNC_LOGGING
