...
void Plugin::AMD::EncoderH264::PacketPriorityAndKeyframe(amf::AMFDataPtr& pData, struct encoder_packet* packet)
{
	...
	case AMF_VIDEO_ENCODER_OUTPUT_DATA_TYPE_IDR:
		ELOGD << format_string("[Plugin::AMD::EncoderH264::PacketPriorityAndKeyframe] FrameType(%d) IDR", (int)pktType);
...
std::string Plugin::AMD::EncoderH264::HandleTypeOverride(amf::AMFSurfacePtr& d, uint64_t index, bool is_key_frame)
{
